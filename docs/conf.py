...
rqmt = pkg_resources.require('zope.app.apidoc')[0]
...
#
# html_title = u'zope.app.apidoc vXXX'
...
htmlhelp_basename = 'zopeapp.apidocdoc'
...
latex_documents = [
    (master_doc, 'zopeapp.apidoc.tex', u'zope.app.apidoc Documentation',
...
man_pages = [
    (master_doc, 'zopeapp.apidoc', u'zope.app.apidoc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'zopeapp.apidoc', u'zope.app.apidoc Documentation',
     author, 'zopeapp.apidoc', 'One line description of project.',
     'Miscellaneous'),
]
...
extlinks = {'issue': ('https://github.com/zopefoundation/zope.app.apidoc/issues/%s',
                      'issue #'),
            'pr': ('https://github.com/zopefoundation/zope.app.apidoc/pull/%s',
                   'pull request #')}
